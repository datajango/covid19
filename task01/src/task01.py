...
# Expected Submission
#
# To be valid, a [submission](https://www.kaggle.com/product-feedback/121068) must be contained in a single notebook 
# made public on or before the submission deadline. Participants are free to use additional datasets
# in addition to the official Kaggle dataset, but those datasets must also be publicly available on either
# Kaggle, Allen.ai, or Semantic Scholar in order for the submission to be valid. Participants must
# also accept the [competition rules](https://www.kaggle.com/cord-19-rules-accept-form).
#
# Evaluation
#
...
# By each of these submission deadlines, you must have accepted the
# [rules](https://www.kaggle.com/cord-19-rules-accept-form) and
# shared your notebook submission publicly to be considered for
# prizes in each respective round
